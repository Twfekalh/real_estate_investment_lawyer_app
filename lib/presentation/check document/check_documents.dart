...
//   const CheckDocumentView({super.key, required this.propertyId});
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomSendButton(
          ...
          onTap: () {
            ...
            GoRouter.of(context).push(AppRouter.kCheckView, extra: legalCheck);
            // ignore: unrelated_type_equality_checks
            // if (["confirm"] == CustomSendButton) {
            //   final legalCheck = ["legalCheckObject"];
            //   GoRouter.of(
            //     context,
